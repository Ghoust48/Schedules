...
namespace ASP.NETCoreWebApplication.Controllers
{
    ...
    public class TimetablesController : ControllerBase
    {
        ...
        // GET: api/Timetables
        [HttpGet]
        public async Task<ActionResult<ApiResult<TimetableDTO>>> GetTimetables(int pageIndex = 0,
            int pageSize = 10,
        ...
        {
            return await ApiResult<TimetableDTO>.CreateAsync(
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Timetable>> PostTimetable(TimetableDTO timetableDto)//(Timetable timetable)
        {
