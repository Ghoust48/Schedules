...
export class LessonTypeComponent implements OnInit {
  ...
  private _lessonType: MatTableDataSource<LessonType>;
  ...
  constructor(private _lessonTypeService: LessonTypeService) { }
  ...
  public getData(event: PageEvent) {
    ...
    this._lessonTypeService.getData<ApiResult<LessonType>>(
      event.pageIndex,
      event.pageSize,
      sortColumn,
      sortOrder,
      ...
      .subscribe(result => {
        ...
        this.lessonType = new MatTableDataSource<LessonType>(result.data);
  ...
  get lessonType(): MatTableDataSource<LessonType> {
    return this._lessonType;
  }

  set lessonType(value: MatTableDataSource<LessonType>) {
